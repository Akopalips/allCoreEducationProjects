...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        mailBox.get("H.P. Lovecraft").stream().peek(System.out::println);
    ...
    public static class MailService<E> implements Consumer<Message<E>> {
        private final Map<String, List<E>> mailBox = new HashMap() {
            @Override
            public List<E> get(Object key) {
                return this.containsKey(key) ? (List<E>) super.get(key) : new LinkedList();
            }
        };
        ...
        @Override
        public void accept(Message<E> rawNode) {
            mailBox.computeIfAbsent(rawNode.to, k -> new LinkedList()).add(rawNode.content);
        }
    }
